...
const SHORTCUT_GROUPS: ShortcutGroup[] = [
  {
    ...
    shortcuts: [
      ...
      { keys: ["J", "K"], label: "Focus next / previous card (then use E, H, P, etc.)", sep: "/" },
      { keys: ["Shift", "J / K"], label: "Focus next / previous — wraps at ends" },
      { keys: ["P"], label: "Open Export modal for the focused card (J/K focus)" },
  ...
  },
  {
    ...
    shortcuts: [
      ...
      { keys: ["V"], label: "CVD export — Deuteranopia strip PNG" },
      { keys: ["⇧", "V"], label: "CVD export — Protanopia strip PNG" },
